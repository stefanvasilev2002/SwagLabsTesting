...
test.describe('Swag Labs Automated Testing - Standard User', () => {
  ...
  test('Fill the form and verify total price', async ({ page }) => {
    ...
    await page.fill('input[data-test="firstName"]', 'Andrej');
    await page.fill('input[data-test="lastName"]', 'Vlahovski');
